...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.25138137359890156f && tensor_input[0][0] <= -0.24178608640109847f)) abort();
 if(!(tensor_input[0][1] >= 0.13577067640109847f && tensor_input[0][1] <= 0.14536596359890153f)) abort();
 if(!(tensor_input[0][2] >= -0.039956359598901536f && tensor_input[0][2] <= -0.030361072401098466f)) abort();
 if(!(tensor_input[0][3] >= -0.5975738435989015f && tensor_input[0][3] <= -0.5879785564010984f)) abort();
