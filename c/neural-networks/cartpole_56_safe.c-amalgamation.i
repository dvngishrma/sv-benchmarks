...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2488601224820147f && tensor_input[0][0] <= -0.23517777751798533f)) abort();
 if(!(tensor_input[0][1] >= -0.059465752482014675f && tensor_input[0][1] <= -0.04578340751798532f)) abort();
 if(!(tensor_input[0][2] >= -0.07245293248201468f && tensor_input[0][2] <= -0.05877058751798533f)) abort();
 if(!(tensor_input[0][3] >= -0.3498943324820147f && tensor_input[0][3] <= -0.33621198751798537f)) abort();
