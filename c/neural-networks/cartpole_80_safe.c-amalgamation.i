...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2548340255436028f && tensor_input[0][0] <= -0.24483311445639722f)) abort();
 if(!(tensor_input[0][1] >= -0.05812608254360279f && tensor_input[0][1] <= -0.04812517145639721f)) abort();
 if(!(tensor_input[0][2] >= -0.05867811554360279f && tensor_input[0][2] <= -0.04867720445639721f)) abort();
 if(!(tensor_input[0][3] >= -0.3367599355436028f && tensor_input[0][3] <= -0.3267590244563972f)) abort();
