...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4338470831422797f && tensor_input[0][0] <= 0.48725007685772026f)) abort();
 if(!(tensor_input[0][1] >= -0.1278917768577203f && tensor_input[0][1] <= -0.0744887831422797f)) abort();
 if(!(tensor_input[0][2] >= 0.00923510314227971f && tensor_input[0][2] <= 0.06263809685772029f)) abort();
 if(!(tensor_input[0][3] >= -0.0004288648577202882f && tensor_input[0][3] <= 0.05297412885772029f)) abort();
