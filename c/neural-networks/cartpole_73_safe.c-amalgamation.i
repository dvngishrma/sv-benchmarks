...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2673144981930642f && tensor_input[0][0] <= -0.2599194618069358f)) abort();
 if(!(tensor_input[0][1] >= -0.4450191581930642f && tensor_input[0][1] <= -0.43762412180693583f)) abort();
 if(!(tensor_input[0][2] >= -0.05413893619306421f && tensor_input[0][2] <= -0.046743899806935794f)) abort();
 if(!(tensor_input[0][3] >= 0.20545317180693579f && tensor_input[0][3] <= 0.21284820819306421f)) abort();
