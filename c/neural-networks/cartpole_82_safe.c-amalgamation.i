...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.43839946351139586f && tensor_input[0][0] <= 0.4475139364886041f)) abort();
 if(!(tensor_input[0][1] >= -0.3013308164886041f && tensor_input[0][1] <= -0.29221634351139586f)) abort();
 if(!(tensor_input[0][2] >= 0.0544146635113959f && tensor_input[0][2] <= 0.0635291364886041f)) abort();
 if(!(tensor_input[0][3] >= 0.3250685835113959f && tensor_input[0][3] <= 0.33418305648860414f)) abort();
