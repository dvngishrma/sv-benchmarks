...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.04023446886873373f && tensor_input[0][0] <= 0.10047065113126626f)) abort();
 if(!(tensor_input[0][1] >= 0.7540650488687337f && tensor_input[0][1] <= 0.8143012311312663f)) abort();
 if(!(tensor_input[0][2] >= -0.13800207113126628f && tensor_input[0][2] <= -0.07776588886873374f)) abort();
 if(!(tensor_input[0][3] >= -1.2881426911312661f && tensor_input[0][3] <= -1.2279065088687338f)) abort();
