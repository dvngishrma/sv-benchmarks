...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2858820573630534f && tensor_input[0][0] <= -0.2726388626369466f)) abort();
 if(!(tensor_input[0][1] >= -0.8390224973630533f && tensor_input[0][1] <= -0.8257793026369467f)) abort();
 if(!(tensor_input[0][2] >= -0.032890632363053375f && tensor_input[0][2] <= -0.019647437636946624f)) abort();
 if(!(tensor_input[0][3] >= 0.8065224026369466f && tensor_input[0][3] <= 0.8197655973630533f)) abort();
