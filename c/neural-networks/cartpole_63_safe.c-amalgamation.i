...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.45039583918067894f && tensor_input[0][0] <= 0.45516596081932104f)) abort();
 if(!(tensor_input[0][1] >= -0.10339926081932106f && tensor_input[0][1] <= -0.09862913918067893f)) abort();
 if(!(tensor_input[0][2] >= 0.044442855180678933f && tensor_input[0][2] <= 0.04921297681932106f)) abort();
 if(!(tensor_input[0][3] >= 0.020006369180678937f && tensor_input[0][3] <= 0.024776490819321064f)) abort();
