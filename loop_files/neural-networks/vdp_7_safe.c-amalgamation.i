...
int main()
{
 ...
 if(!(!((tensor_output[0][1] <= 0.6753632844882149) && (tensor_output[0][1] >= -0.6753632844882149) && (tensor_output[0][2] <= 0.6753632844882149) && (tensor_output[0][2] >= -0.6753632844882149) && (tensor_output[0][0] >= 0.27808111751725895)))) reach_error();
 return 0;
}
