...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2529235666821996f && tensor_input[0][0] <= -0.23678291331780038f)) abort();
 if(!(tensor_input[0][1] >= 0.1336445133178004f && tensor_input[0][1] <= 0.14978516668219963f)) abort();
 if(!(tensor_input[0][2] >= -0.06131201168219961f && tensor_input[0][2] <= -0.045171358317800385f)) abort();
 if(!(tensor_input[0][3] >= -0.6265739266821997f && tensor_input[0][3] <= -0.6104332733178004f)) abort();
