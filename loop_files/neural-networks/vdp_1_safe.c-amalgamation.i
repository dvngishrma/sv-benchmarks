...
int main()
{
 ...
 if(!(!((tensor_output[0][1] <= 0.37980702501135716) && (tensor_output[0][1] >= -0.37980702501135716) && (tensor_output[0][2] <= 0.37980702501135716) && (tensor_output[0][2] >= -0.37980702501135716) && (tensor_output[0][0] >= 0.2555093881187115)))) reach_error();
 return 0;
}
