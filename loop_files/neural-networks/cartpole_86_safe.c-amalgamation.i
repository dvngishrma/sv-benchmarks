...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.25661109096866197f && tensor_input[0][0] <= -0.2451389090313381f)) abort();
 if(!(tensor_input[0][1] >= 0.13748726903133807f && tensor_input[0][1] <= 0.14895945096866192f)) abort();
 if(!(tensor_input[0][2] >= -0.06651282396866194f && tensor_input[0][2] <= -0.05504064203133806f)) abort();
 if(!(tensor_input[0][3] >= -0.6577961909686619f && tensor_input[0][3] <= -0.6463240090313381f)) abort();
