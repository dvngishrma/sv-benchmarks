...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2550689588985097f && tensor_input[0][0] <= -0.2502539211014903f)) abort();
 if(!(tensor_input[0][1] >= 0.13898561110149027f && tensor_input[0][1] <= 0.14380064889850974f)) abort();
 if(!(tensor_input[0][2] >= -0.04386312889850973f && tensor_input[0][2] <= -0.03904809110149026f)) abort();
 if(!(tensor_input[0][3] >= -0.6135099788985098f && tensor_input[0][3] <= -0.6086949411014903f)) abort();
