...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.042135729200575824f && tensor_input[0][0] <= 0.11430241079942419f)) abort();
 if(!(tensor_input[0][1] >= 0.16429373920057583f && tensor_input[0][1] <= 0.2364604207994242f)) abort();
 if(!(tensor_input[0][2] >= -0.15709388079942418f && tensor_input[0][2] <= -0.08492719920057581f)) abort();
 if(!(tensor_input[0][3] >= -0.44746284079942417f && tensor_input[0][3] <= -0.37529615920057585f)) abort();
