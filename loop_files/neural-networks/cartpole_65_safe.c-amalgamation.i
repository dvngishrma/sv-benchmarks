...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.42780327986502886f && tensor_input[0][0] <= 0.4309316801349712f)) abort();
 if(!(tensor_input[0][1] >= -0.8830843501349711f && tensor_input[0][1] <= -0.8799559498650288f)) abort();
 if(!(tensor_input[0][2] >= 0.08037730986502886f && tensor_input[0][2] <= 0.08350571013497113f)) abort();
 if(!(tensor_input[0][3] >= 1.194896199865029f && tensor_input[0][3] <= 1.1980246001349713f)) abort();
